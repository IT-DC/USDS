...
/**
 ** \file bisonCppTextReader.hh
 ** Define the cppTextReader::parser class.
 */
...
/* Debug traces.  */
#ifndef CPP_TEXTDEBUG
# if defined YYDEBUG
#if YYDEBUG
#   define CPP_TEXTDEBUG 1
#  else
#   define CPP_TEXTDEBUG 0
#  endif
...
#line 68 "bisonCppTextReader.hh" // lalr1.cc:371
  ...
  /// A Bison parser.
  class BisonCppTextReader
  {
  public:
#ifndef CPP_TEXTSTYPE
...
#line 86 "bisonCppTextReader.hh" // lalr1.cc:371
  ...
  private:
    ...
    BisonCppTextReader (const BisonCppTextReader&);
    BisonCppTextReader& operator= (const BisonCppTextReader&);
...
#endif // !YY_CPP_TEXT_BISONCPPTEXTREADER_HH_INCLUDED
