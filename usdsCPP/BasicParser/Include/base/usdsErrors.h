...
namespace usds
{
	enum errorCode
	{
		...
		BASIC_PARSER_BODY_IS_EMPTY = 9004,
		...
		// Body
		BODY_ERROR_TAG_TYPE = 13001,
		BODY_ERROR_TAG_ROOT = 13002,
		BODY_TAG_NOT_FOUND = 13003,
		// Body Struct Tag
		BODY_STRUCT_TAG_FIELD_NOT_FOUND = 14001,
		BODY_STRUCT_TAG_ERROR_FIELD_TYPE = 14002,
		// Body Base Type
		USDS_BASE_TYPE_UNSUPPORTED_CONVERTION = 15001,
		// Body UVARINT type
		USDS_UVARINT_ERROR_VALUE = 16001,
		// Body Array Type
		USDS_ARRAY_ELEMENT_NOT_TAG = 17001,
		USDS_ARRAY_UNFIXED_ELEMENT_SIZE = 17002,
		// Body Json Creator
		BODY_JSON_CREATOR_UNSUPPORTABLE_ENCODE = 18001
