...
namespace usds
{
	...
	public:
		...
		{
			throw ErrorStack("TemplateObjectPool::createObject") << ErrorMessage(OBJECT_POOL__ALLOCATE_ERROR, "Can't allocate memory for the object");
		};
